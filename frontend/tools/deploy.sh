...
PROJECT_ID["stable", "prod"]="pan-os-upgrade"
PROJECT_ID["stable", "beta"]="beta-angular-material-io"

PROJECT_ID["v5", "dev"]="material-docs-dev-v5"
PROJECT_ID["v5", "prod"]="v5-pan-os-upgrade"

PROJECT_ID["v6", "dev"]="material-docs-dev-v6"
PROJECT_ID["v6", "prod"]="v6-pan-os-upgrade"

PROJECT_ID["v7", "dev"]="material-docs-dev-v7"
PROJECT_ID["v7", "prod"]="v7-pan-os-upgrade"

PROJECT_ID["v8", "prod"]="v8-pan-os-upgrade"

PROJECT_ID["v9", "prod"]="v9-pan-os-upgrade"

PROJECT_ID["v10", "prod"]="v10-pan-os-upgrade"

PROJECT_ID["v11", "prod"]="v11-pan-os-upgrade"

PROJECT_ID["v12", "prod"]="v12-pan-os-upgrade"
