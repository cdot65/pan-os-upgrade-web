export const SNAPSHOT_ASSURANCE_SCRIPT = `
"""Snapshot Assurance universal script

This script will run an SNAPSHOT Assurance operation on the Firewall and return the result of the operation.
All parameters are passed as arguments, and the script is exposed by the backend REST API.
"""
