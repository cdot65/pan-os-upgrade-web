export const ARP_ASSURANCE_SCRIPT = `
"""Upgrade Assurance universal script

This script will run an ARP Assurance operation on the Firewall and return the result of the operation.
